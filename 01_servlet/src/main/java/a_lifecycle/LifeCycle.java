 ...
 *   
 *   2. WEB-INF/web.xml 파일에 Servlet 클래스 등록 시 매핑
 *   	<servlet>
...
public class LifeCycle extends HttpServlet {
	...
	/*
	 * * service()
	 *   1. 클라이언트로부터 요청을 받을 수 있음 (HttpServletRequest 매개변수)
	 *      클라이언트로 응답할 수 있음 		 (HttpServletResponse 매개변수)
	 *   2. service() 메소드가 없을 경우 여기서 요청과 응답을 처리함
	 *   	servive() 메소드가 없을 경우 doGet() 또는 doPost() 메소드가 요청방식에 따라 호출됨
	 */
	...
	/**
	 * * doGet()
	 *   1. service() 메소드가 없을 경우 GET방식 요청 시 자동으로 호출됨
	 *   2. GET 방식 요청 케이스
